...
void set_json_response(struct http_response_ctx *ctx, enum http_status status,
		       const char *body, size_t body_len);
void set_text_response(struct http_response_ctx *ctx, enum http_status status,
		       const char *body, size_t body_len);
