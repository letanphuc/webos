...
#define EXAMPLE_SENSOR_INIT(i)                                                                              \
  ...
  static const struct example_sensor_config example_sensor_config_##i = {                                   \
      .input = GPIO_DT_SPEC_INST_GET(i, input_gpios),                                                       \
                                                                                                            ...
                                                                                                            \
  DEVICE_DT_INST_DEFINE(i, example_sensor_init, NULL, &example_sensor_data_##i, &example_sensor_config_##i, \
                        POST_KERNEL, CONFIG_SENSOR_INIT_PRIORITY, &example_sensor_api);
